    ...
    def _convert(remaining_value, base, exp):
        ...
        if remaining_value >= 0 and exp >= 0:
            ...
            if factor <= remaining_value:
                ...
                return stringify(multiple) + _convert(remaining_value-multiple*factor, base, exp-1)
            else:
                return "0" + _convert(remaining_value, base, exp-1)
        else:
            return ""

    return "%s/%s" % (_convert(value, base, int(math.log(value, base))), base)
