...
def package():
    print "This is where we can plug in code to run setup.py to generate a bundle."

def publish():
    print "This is where we can plug in code to upload our tarball to S3 or some other download site."

def register():
    print "setup.py has a built in function to 'register' a release to PyPI. It's convenient to put a hook in here."
