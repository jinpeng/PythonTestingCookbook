...
class RomanNumeralTest(unittest.TestCase):
    ...
    # test cases to test edges of converting to Roman
    ...
    # test cases to test edges of converting to Decimal
    ...
    # test cases to exercise the tiers of converting decimal to Roman
    ...
    # test cases which input unexpected values
